...
ADMINS = (
    ('Rafal Sztandera', 'rafszt@gmail.com'),
)
...
ALLOWED_HOSTS = [u'skt.wroclaw.pl', u'www.skt.wroclaw.pl']
...
WAGTAIL_SITE_NAME = 'Studencki Klub Turystyczny'
